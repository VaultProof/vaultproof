...
ATTESTATION_TOKEN_HASH="${AZURE_ATTESTATION_TOKEN_HASH:-}"
...
KEY_RELEASE_URL_OVERRIDE="${AZURE_KEY_RELEASE_URL:-}"
UNWRAP_KEY_ID_OVERRIDE="${AZURE_KEY_ID:-}"
UNWRAP_KEY_VERSION_OVERRIDE="${AZURE_KEY_VERSION:-}"
KEY_RELEASE_CACHE_TTL_MS="${AZURE_KEY_RELEASE_CACHE_TTL_MS:-60000}"
...
KEY_RELEASE_URL="${KEY_RELEASE_URL_OVERRIDE:-$(deployment_output prototypeKeyReleaseUrl)}"
ATTESTATION_PROVIDER_URI="$(deployment_output attestationProviderUri)"
UNWRAP_KEY_ID="${UNWRAP_KEY_ID_OVERRIDE:-$(deployment_output unwrapKeyId)}"
CONFIDENTIAL_VM_RESOURCE_ID="$(deployment_output confidentialVmResourceId)"
UNWRAP_KEY_VERSION="${UNWRAP_KEY_VERSION_OVERRIDE:-${UNWRAP_KEY_ID##*/}}"
...
AZURE_KEY_RELEASE_CACHE_TTL_MS=${KEY_RELEASE_CACHE_TTL_MS}
AZURE_ATTESTATION_TOKEN_HASH=${ATTESTATION_TOKEN_HASH}
AZURE_KEY_RELEASE_POLICY_HASH=${KEY_RELEASE_POLICY_HASH}
AZURE_KEY_ID=${UNWRAP_KEY_ID}
AZURE_KEY_VERSION=${UNWRAP_KEY_VERSION}
