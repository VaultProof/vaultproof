...
echo "3. Run render-executor-env.sh from Cloud Shell and copy output to /etc/vaultproof/enterprise-secure-executor.env."
echo "4. Grant the VM identity permission to release the unwrap key."
echo "5. Start vaultproof-executor and confirm /health.production_ready is true."
