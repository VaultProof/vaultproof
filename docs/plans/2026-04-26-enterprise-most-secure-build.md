...
- [x] `/app`, `/app/`, `/app/dashboard`: enterprise dashboard home with business-ready sidebar navigation, overview/security/access/operations/features tabs, a built-feature map, runtime posture, org summary, project health, access, audit, and recent runtime activity.
