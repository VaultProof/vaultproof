...
Last updated: 2026-06-05T16:31:54.928Z
...
- `npm run verify:gcp-enterprise-edge` passed after deploying build `38d33adc`. The verifier confirmed edge IP `34.102.179.105`, active managed TLS for `enterprise.vaultproof.dev`, healthy backend `vaultproof-enterprise-runtime-1:3001`, `/health`, and `/readiness`.
- `npm run verify:gcp-enterprise-cloud-armor` passed after deploying build `38d33adc`. The verifier confirmed `vaultproof-enterprise-armor` is attached to `vaultproof-enterprise-backend`, `/health` returns `200`, and the `/.env` scanner probe returns `403`.
...
- Build `38d33adc` is the current deployed GCP image tag for both control plane and executor containers.
...
- Control plane image: `us-central1-docker.pkg.dev/vaultproof-prod/vaultproof/enterprise-control-plane:38d33adc`
- Control plane digest: `sha256:f5c1695cdf4d5083909dab87e7c6a78ddbc20e148b5935974cde4de2beea7f64`
- Control plane built at: `2026-06-05T16:31:12.472688183Z`
- Executor image: `us-central1-docker.pkg.dev/vaultproof-prod/vaultproof/enterprise-secure-executor:38d33adc`
- Executor digest: `sha256:abc9e529dbae03987cbc95efd79060b2a8cad2eeb724868226e448f236d27bee`
- Executor built at: `2026-06-05T16:31:26.265965645Z`
