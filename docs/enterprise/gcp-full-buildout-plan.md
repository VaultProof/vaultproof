...
- Paid-user entitlements page at `https://enterprise.vaultproof.dev/app/entitlements` for contract status, capacity envelope, usage meters, expansion recommendation, billing owner, success owner, support tier, renewal/review date, incident-response boundary, copyable capacity brief, and customer-safe JSON proof
