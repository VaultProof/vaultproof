...
Last validated GCP image build: `0a2bcee`
...
- Updated: 2026-05-13T10:19:02.510Z
...
| Scanner placeholder | `https://enterprise.vaultproof.dev/app/scanner` |
...
| Customer evidence packet | Built | `https://enterprise.vaultproof.dev/app/evidence` assembles readiness, go/no-go launch decision and blockers, access-review, audit export links, API inventory proof, policy drift proof, integration rollout proof, provider posture, rollout workflow, and a copy/download JSON proof packet scoped to the selected organization without exposing secrets. |
