...
Last validated GCP image build: `7037b725`

- Control plane digest: `sha256:c4419c7d79acd825635d8aa0c5df01912fe006812246a283b315079f14451863`
- Executor digest: `sha256:8cf4c63c3f2fab128e20e7a67ba7a02a08b10ffdfe7885ea3a4f570a57e4b8f2`
- Updated: 2026-05-14T20:20:33.842Z
...
| Demo walkthrough | `https://enterprise.vaultproof.dev/app/demo` |
...
| Paid-pilot proposal | `https://enterprise.vaultproof.dev/app/pilot` |
| Pilot success tracker | `https://enterprise.vaultproof.dev/app/pilot-success` |
...
| Paid-customer onboarding | `https://enterprise.vaultproof.dev/app/onboarding` |
| Launch support room | `https://enterprise.vaultproof.dev/app/support` |
...
| Launch support room | Built | `https://enterprise.vaultproof.dev/app/support` packages founder-led launch-week support for the demo with support readiness, internal admin boundary, read-only default, approval-gated actions, optional 24-hour incident-response add-on boundary, customer handoff checklist, and copyable support brief. `https://enterprise.vaultproof.dev/app/evidence` includes `launch_support_readiness` and `https://enterprise.vaultproof.dev/app/demo` now has a buyer-facing launch support proof point. |
| Monitoring evidence kit | Built | `https://enterprise.vaultproof.dev/app/evidence` now includes `monitoring_evidence` with runtime readiness, traffic/denial/error posture, alert workflow path, Cloud Armor verification evidence, budget alert guardrail, live monitoring gate command, customer handoff notes, and redacted secret boundaries. `https://enterprise.vaultproof.dev/app/demo` adds a buyer-facing monitoring proof point and `https://enterprise.vaultproof.dev/app/runbooks` lists the monitoring evidence review before pilot traffic. |
| Release evidence center | Built | `https://enterprise.vaultproof.dev/app/release` records browser-local release evidence per organization: release label, build/image tag, change summary, approver, verifier, verification status, rollout state, rollback owner/path, and customer-safe evidence notes. It redacts secret-like input, exports `vaultproof_enterprise_release_evidence` JSON, and `https://enterprise.vaultproof.dev/app/evidence`, `/app/demo`, and `/app/security-review` include release status without raw env values, tokens, provider keys, request bodies, or customer payloads. Persistent audited release records and automated deploy evidence capture remain follow-up work. |
| Paid-pilot tester readiness | Built | `https://enterprise.vaultproof.dev/app/testers` records browser-local tester readiness per organization: tester name/email, team, role, scenario, login/scenario status, VaultProof owner, blocker note, and customer-safe feedback. It redacts secret-like input, exports `vaultproof_enterprise_paid_pilot_tester_readiness` JSON, and `https://enterprise.vaultproof.dev/app/evidence`, `/app/demo`, `/app/security-review`, `/app/plans`, and `/app/runbooks` link to tester readiness. Persistent audited tester records, invite automation, and structured feedback workflow remain follow-up work. |
| Paid-user entitlements | Built | `https://enterprise.vaultproof.dev/app/entitlements` records browser-local contract/capacity metadata per organization: package, contract status, monthly calls, provider-slot allowance, seats, support tier, incident-response add-on stance, runtime type, renewal/review date, billing owner, success owner, retention label, and customer-safe notes. It compares the entitlement envelope to existing organization, traffic, provider-slot, member, readiness, and go/no-go evidence; exports `vaultproof_enterprise_entitlements` JSON; and `https://enterprise.vaultproof.dev/app/evidence`, `/app/demo`, `/app/security-review`, `/app/plans`, and `/app/runbooks` include the entitlement status. Persistent audited contract records, billing integration, hard limit enforcement, amendment history, and renewal automation remain follow-up work. |
| Paid-customer onboarding | Built | `https://enterprise.vaultproof.dev/app/onboarding` records browser-local activation evidence per organization for the paid customer path: customer kickoff owner, enterprise admin login handoff, first workload owner, support handoff, capacity/renewal review, key posture acceptance or rotation scheduling, and customer testing window. It combines existing readiness, SSO, org/project/member/provider, go/no-go, entitlements, tester, inventory, rollout, and support evidence; exports `vaultproof_enterprise_paid_onboarding` JSON without secrets; and `/app/evidence`, `/app/demo`, `/app/security-review`, `/app/plans`, `/app/entitlements`, and `/app/runbooks` link to the onboarding status. Persistent audited onboarding records, invite automation, customer task notifications, and staff-admin activation workflow remain follow-up work. |
| Security review packet | Built | `https://enterprise.vaultproof.dev/app/security-review` packages customer-safe architecture, control coverage, evidence links, open review items, known limitations, common security/procurement answers, and secret exclusions into a copyable review packet. `https://enterprise.vaultproof.dev/app/evidence` now includes `security_review_packet`, while `https://enterprise.vaultproof.dev/app/demo`, `https://enterprise.vaultproof.dev/app/plans`, and `https://enterprise.vaultproof.dev/app/runbooks` link reviewers to the packet. |
| Paid-pilot proposal builder | Built | `https://enterprise.vaultproof.dev/app/pilot` lets the team shape the first customer proposal with browser-local workload scope, provider path, owner group, expected monthly calls, monthly price, 20% sales commission math, support tier, incident-response add-on stance, success metric, guardrails, close steps, and copyable proposal text. `https://enterprise.vaultproof.dev/app/evidence` includes `pilot_proposal`, while `https://enterprise.vaultproof.dev/app/demo`, `https://enterprise.vaultproof.dev/app/plans`, and `https://enterprise.vaultproof.dev/app/runbooks` link to the proposal builder. |
| Pilot success tracker | Built | `https://enterprise.vaultproof.dev/app/pilot-success` tracks live checks, browser-local customer milestones, evidence links, blockers, weekly update copy, and expansion/no-go readiness. `https://enterprise.vaultproof.dev/app/evidence` includes `pilot_success_tracker`, while `https://enterprise.vaultproof.dev/app/demo`, `https://enterprise.vaultproof.dev/app/plans`, and `https://enterprise.vaultproof.dev/app/runbooks` link to the tracker. |
