...
Last validated GCP image build: `2fcbabd0`

- Control plane digest: `sha256:c8834d05ff229410a0e0f7eecfc50518c097cb946faa609deabec16b539e1955`
- Executor digest: `sha256:1b911da723e7b37b049ca7977ba3df78555513941e33b48f7879b8fabd41709d`
- Updated: 2026-05-14T07:19:03.238Z
...
| Customer demo script | Built | `https://enterprise.vaultproof.dev/app/demo` gives sales and founders a repeatable buyer walkthrough with live workspace facts, proof path links, safety guardrails, tester readiness, contract entitlements, objection answers, paid-pilot close steps, and a copyable talk track. It uses existing readiness/bootstrap data and does not include secrets. |
...
| Customer evidence packet | Built | `https://enterprise.vaultproof.dev/app/evidence` assembles readiness, go/no-go launch decision and blockers, access-review, audit export links, API inventory proof, policy drift proof, integration rollout proof, scanner exposure proof, release evidence proof, paid-pilot tester proof, contract entitlements proof, provider posture, rollout workflow, and a copy/download JSON proof packet scoped to the selected organization without exposing secrets. |
