...
2. **Identifies** each key by shape against a catalog of 104 providers across AI, translation, email, payments, DevOps, observability, SaaS, and databases.
...
Detection is driven by [providers.json](https://vaultproof.dev/providers.json) which is fetched at runtime (with a bundled fallback). Today's catalog has 104 provider signatures.

Common examples include OpenAI, Azure OpenAI, Anthropic, Google/Gemini, DeepL, MiniMax, Voyage AI, Jina AI, AI21, AssemblyAI, Groq, xAI, OpenRouter, DeepSeek, Mistral, Together AI, Fireworks AI, Cohere, Replicate, Hugging Face, Perplexity, Cerebras, ElevenLabs, Stripe, Paddle, Square, Chargebee, Adyen, Resend, SendGrid, Mailgun, Postmark, Brevo, Twilio, GitHub, GitLab, Linear, Notion, Slack, Discord, Jira, Zendesk, Freshdesk, Supabase, Neon, PlanetScale, Upstash, Pinecone, Vercel, Cloudflare, Netlify, Render, Heroku, DigitalOcean, Fastly, HCP Terraform, Pulumi, npm Registry, Sentry, Datadog, New Relic, Grafana, Honeycomb, Snyk, PagerDuty, LaunchDarkly, HubSpot, Intercom, Airtable, Contentful, Sanity, Shopify, Firecrawl, E2B, Exa, Tavily, and Trigger.dev.
