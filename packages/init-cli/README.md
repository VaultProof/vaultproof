...
2. **Identifies** each key by shape against a catalog of 132 providers across AI, translation, email, payments, DevOps, observability, SaaS, and databases.
...
Detection is driven by [providers.json](https://vaultproof.dev/providers.json) which is fetched at runtime (with a bundled fallback). Today's catalog has 132 provider signatures.

Common examples include OpenAI, Azure OpenAI, Anthropic, Google/Gemini, DeepL, MiniMax, Voyage AI, Jina AI, AI21, AssemblyAI, Groq, xAI, OpenRouter, DeepSeek, Mistral, Together AI, Fireworks AI, Cohere, Replicate, Hugging Face, Perplexity, Cerebras, ElevenLabs, Hume AI, RunPod, Browserbase, Stripe, Paddle, Square, Paystack, Lemon Squeezy, Chargebee, Adyen, Resend, SendGrid, Mailgun, Postmark, Brevo, Twilio, GitHub, GitLab, Bitbucket, Linear, Notion, Slack, Discord, Jira, Zendesk, Freshdesk, Supabase, Neon, PlanetScale, Upstash, Pinecone, Qdrant, Meilisearch, Typesense, Elasticsearch, Turso, Vercel, Cloudflare, Netlify, Render, Heroku, Railway, Fly.io, DigitalOcean, Fastly, HCP Terraform, Pulumi, npm Registry, CircleCI, Buildkite, Semgrep, SonarQube Cloud, Sentry, Datadog, New Relic, Better Stack, Grafana, Honeycomb, Raygun, LogSnag, Snyk, Doppler, PagerDuty, LaunchDarkly, Segment, Plausible, HubSpot, Intercom, Airtable, Contentful, Sanity, Shopify, Webflow, Svix, Knock, Firecrawl, E2B, Exa, Tavily, and Trigger.dev.
