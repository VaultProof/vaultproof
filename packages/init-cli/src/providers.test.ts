...
const SAMPLES: Sample[] = [
  ...
  { providerId: 'sambanova', varName: 'SAMBANOVA_API_KEY', value: 's'.repeat(40) },
  { providerId: 'nvidia-nim', varName: 'NVIDIA_API_KEY', value: 'nvapi-' + 'n'.repeat(40) },
  { providerId: 'friendli', varName: 'FRIENDLI_TOKEN', value: 'flp_' + 'f'.repeat(40) },
  { providerId: 'hyperbolic', varName: 'HYPERBOLIC_API_KEY', value: 'h'.repeat(40) },
  { providerId: 'vapi', varName: 'VAPI_API_KEY', value: 'v'.repeat(40) },
  { providerId: 'retell', varName: 'RETELL_API_KEY', value: 'r'.repeat(40) },
  { providerId: 'rev-ai', varName: 'REVAI_ACCESS_TOKEN', value: 'r'.repeat(40) },
  { providerId: 'speechmatics', varName: 'SPEECHMATICS_API_KEY', value: 's'.repeat(40) },
  { providerId: 'gladia', varName: 'GLADIA_API_KEY', value: 'g'.repeat(40) },
  { providerId: 'soniox', varName: 'SONIOX_API_KEY', value: 's'.repeat(40) },
  { providerId: 'resemble-ai', varName: 'RESEMBLE_API_KEY', value: 'r'.repeat(40) },
  { providerId: 'infobip', varName: 'INFOBIP_API_KEY', value: 'i'.repeat(40) },
  { providerId: 'mailchimp', varName: 'MAILCHIMP_API_KEY', value: 'm'.repeat(40) + '-us1' },
  { providerId: 'fauna', varName: 'FAUNA_SECRET', value: 'f'.repeat(40) },
  { providerId: 'zilliz', varName: 'ZILLIZ_API_KEY', value: 'z'.repeat(40) },
  { providerId: 'pipedream', varName: 'PIPEDREAM_API_KEY', value: 'p'.repeat(40) },
  { providerId: 'attio', varName: 'ATTIO_API_TOKEN', value: 'a'.repeat(40) },
  { providerId: 'recurly', varName: 'RECURLY_API_KEY', value: 'r'.repeat(40) },
  { providerId: 'phrase', varName: 'PHRASE_ACCESS_TOKEN', value: 'p'.repeat(40) },
  { providerId: 'transifex', varName: 'TRANSIFEX_API_TOKEN', value: '1/' + 't'.repeat(40) },
  { providerId: 'revenuecat', varName: 'REVENUECAT_SECRET_API_KEY', value: 'sk_' + 'r'.repeat(40) },
  { providerId: 'qovery', varName: 'QOVERY_API_TOKEN', value: 'q'.repeat(40) },
  { providerId: 'northflank', varName: 'NORTHFLANK_API_TOKEN', value: 'n'.repeat(40) },
  { providerId: 'koyeb', varName: 'KOYEB_API_TOKEN', value: 'k'.repeat(40) },
  { providerId: 'deno-deploy', varName: 'DENO_DEPLOY_TOKEN', value: 'ddo_' + 'd'.repeat(40) },
];
