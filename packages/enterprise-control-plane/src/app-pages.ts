      ...
      function renderPanels(orgPayload, readiness, overview) {
        ...
        if (PAGE_MODE === 'runbooks') {
          byId('runbooksSafeList').innerHTML = [
            ...
            row('APIM policy template smoke', 'npm run test:enterprise-apim-policies validates the VaultProof-managed, customer-managed, device, and mTLS APIM policy templates before customer handoff.', 'read-only', 'good'),
