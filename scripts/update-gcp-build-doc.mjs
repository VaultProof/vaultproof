...
- \`npm run qa:enterprise-live-app\` passed against \`https://${edgeDomain}\`: \`production_ready: true\`, \`security_profile: google-confidential-production\`, 27 app paths, 5 staff-only paths, and 31 links checked.
