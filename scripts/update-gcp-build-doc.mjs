...
- \`https://${edgeDomain}/app/onboarding\` is the paid-customer onboarding board: browser-local activation owners, enterprise admin login handoff, first workload owner, support handoff, capacity/renewal review, key posture, customer testing window, and copyable \`vaultproof_enterprise_paid_onboarding\` JSON without secrets.
