...
- \`https://${adminDomain}/\` includes a staff Control Center with sidebar colors matched to the light enterprise palette, signed-on business/user KPIs, SSO and pending-invite posture, total API calls, API calls by business, account-mix charts, and traffic-health charts backed by \`project_access_log_daily_rollups\`.
