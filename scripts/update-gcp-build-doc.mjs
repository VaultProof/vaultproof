...
- \`npm run qa:enterprise-live-app\` passed against \`https://${edgeDomain}\`: \`production_ready: true\`, \`security_profile: google-confidential-production\`, 28 app paths, 5 staff-only paths, and the discovered enterprise links checked.
