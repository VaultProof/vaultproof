...
async function assertEnterpriseLoginRoute() {
  ...
  const supportPages = [
    ...
    },
    {
      ...
      required: ['Contract intake', 'Paid-user readiness', 'Capacity envelope', 'Commercial handoff', 'entitlementsBillingForm', 'entitlementsBillingList', 'entitlementsBillingRows', 'billing_handoff', 'commercial_ready', 'commercial_review', 'invoice status', 'PO status', 'procurement owner', 'payment terms', 'billing-safe note', 'Usage guardrails', 'entitlementsUsageMeterList', 'entitlementsUsageGuardrailList', 'capacity_status', 'remaining_calls', 'expansion_recommendation', 'hard_limit_enforcement', 'copy capacity brief', 'copyEntitlementsCapacityBriefBtn', 'entitlementsCapacityBriefText', 'VaultProof entitlement capacity brief', 'Contract guardrails', 'Handoff path', 'Paid onboarding evidence', 'Launch readiness evidence', 'Support evidence', 'Entitlements JSON', 'vaultproof_enterprise_entitlements', 'data-entitlement-field', 'contract status', 'monthly calls', 'provider slots', 'billing owner', 'success owner', 'support tier', 'incident response', 'renewal/review date', 'copy entitlements JSON', 'ready_for_paid_pilot', 'contract_review', 'Manual contract-controlled', '/app/evidence', '/app/plans', '/app/pilot', '/app/security-review'],
    },
    {
      path: '/app/pilot',
