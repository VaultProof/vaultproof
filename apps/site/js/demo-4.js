// ── Guided Tour ──
  var tourSteps = [
    ...
    { target: '#dev-key-card', text: 'After adding your API keys, go to the API Keys page \u2192 Developer API Keys and create a \u2018vp_live_\u2019 key. This is how your app or CLI authenticates with VaultProof.', position: 'bottom' },
    { target: '#dev-key-card', text: 'Copy the \u2018vp_live_\u2019 key and paste it into your project\u2019s .env file as VAULTPROOF_API_KEY. Then use it as the Bearer token when calling the VaultProof proxy \u2014 your stored keys are now accessible from your app.', position: 'top' },
