(function () {
  ...
  var MESSAGES = {
    en: {
      ...
      'docs.browserTitle': 'User Guide | VaultProof',
      'docs.heroTitle': 'VaultProof User Guide',
      'docs.heroSub': 'Onboarding, setup, providers, dashboard basics, and troubleshooting for teams using VaultProof.',
      ...
      'blog.heroSub': 'API key leaks, supply-chain incidents, AI workflow risks, and practical architecture notes from the VaultProof team.',
    ...
    es: {
      ...
      'docs.browserTitle': 'Guía de usuario | VaultProof',
      'docs.heroTitle': 'Guía de usuario de VaultProof',
      'docs.heroSub': 'Onboarding, configuración, proveedores, conceptos del panel y solución de problemas para equipos que usan VaultProof.',
      'blog.browserTitle': 'VaultProof Insights',
      'blog.heroEyebrow': 'VaultProof Insights',
      'blog.heroTitle': 'Notas de seguridad para equipos que trabajan con claves.',
      'blog.heroSub': 'Fugas de claves API, incidentes de cadena de suministro, riesgos en flujos de IA y notas prácticas de arquitectura del equipo de VaultProof.',
  ...
  Object.assign(MESSAGES.fr, {
    ...
    'docs.heroTitle': 'Guide utilisateur VaultProof',
    'docs.heroSub': 'Onboarding, configuration, fournisseurs, bases du tableau de bord et dépannage pour les équipes qui utilisent VaultProof.',
  ...
  Object.assign(MESSAGES.ru, {
    ...
    'docs.browserTitle': 'Руководство пользователя | VaultProof',
    'docs.heroTitle': 'Руководство пользователя VaultProof',
    'docs.heroSub': 'Онбординг, настройка, провайдеры, основы панели и устранение неполадок для команд, использующих VaultProof.',
  ...
  Object.assign(MESSAGES.he, {
    ...
    'docs.browserTitle': 'מדריך משתמש | VaultProof',
    'docs.heroTitle': 'מדריך משתמש VaultProof',
    'docs.heroSub': 'הצטרפות, הגדרה, ספקים, יסודות הדשבורד ופתרון תקלות לצוותים שמשתמשים ב-VaultProof.',
    'blog.browserTitle': 'VaultProof Insights',
    'blog.heroEyebrow': 'VaultProof Insights',
    'blog.heroTitle': 'הערות אבטחה לצוותים שמוציאים קוד עם מפתחות.',
    'blog.heroSub': 'דליפות מפתחות API, אירועי שרשרת אספקה, סיכוני תהליכי AI והערות ארכיטקטורה מעשיות מצוות VaultProof.',
