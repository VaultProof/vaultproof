(function () {
  ...
  var SUPPORTED_LOCALES = ['en', 'es', 'fr', 'de', 'pt-BR', 'ja', 'zh-CN'];
  var LOCALE_LABELS = {
    en: 'English',
    es: 'Español',
    fr: 'Français',
  ...
  var MESSAGES = {
    en: {
      ...
      'login.eyebrow': '00 / Secure access',
      'login.introTitle': 'Enter the vault. Keep the keys out.',
      'login.introSub': 'Sign in to manage split-key projects, provider proxying, origin locks, and audit logs from the same system that keeps whole API keys away from your apps.',
      'login.authKicker': 'dashboard access',
      'login.authTitle': 'Sign in to VaultProof',
      'login.authSub': 'Manage keys, proxies, scans, and billing from one sealed workspace.',
      ...
      'dashboard.sort': 'sort · last activity ↓',
    ...
    es: {
      ...
      'login.introSub': 'Inicia sesión para gestionar proyectos con claves divididas, proxy de proveedores, bloqueos de origen y logs de auditoría desde el mismo sistema que mantiene las claves API completas fuera de tus apps.',
      ...
      'dashboard.sort': 'ordenar · última actividad ↓',
