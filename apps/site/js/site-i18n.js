(function () {
  ...
  var MESSAGES = {
    en: {
      ...
      'login.introSub': 'Sign in to manage split-key projects, provider proxying, origin locks, and activity logs from the same system that keeps whole API keys away from your apps.',
