    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-24 pb-16 text-center">
        ...
        <div className="flex items-center justify-center gap-4">
          <Link
            href="/keys"
            className="bg-indigo-600 hover:bg-indigo-500 px-6 py-3 rounded-xl font-semibold text-base transition"
          >
            Store Your First Key
          </Link>
          <a
            href="#how-it-works"
            className="border border-gray-700 hover:border-gray-500 px-6 py-3 rounded-xl font-semibold text-base text-gray-300 transition"
          >
            How It Works
          </a>
        </div>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <Link href="/keys" className="inline-block bg-indigo-600 hover:bg-indigo-500 px-8 py-4 rounded-xl font-semibold text-lg transition">
          Get Started Free
        </Link>
      </section>
