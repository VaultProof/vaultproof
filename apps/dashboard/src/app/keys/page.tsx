...
const PROVIDER_PRESETS: ProviderPreset[] = [
  ...
  },
  {
    provider: "deepl",
    label: "DeepL",
    upstream_base_url: "https://api-free.deepl.com",
    auth_header_name: "Authorization",
    auth_header_template: "DeepL-Auth-Key {key}",
    placeholder: "DeepL auth key...",
  },
  {
    provider: "deepl-pro",
    label: "DeepL Pro",
    upstream_base_url: "https://api.deepl.com",
    auth_header_name: "Authorization",
    auth_header_template: "DeepL-Auth-Key {key}",
    placeholder: "DeepL Pro auth key...",
  },
  {
    provider: "voyage",
    label: "Voyage AI",
    upstream_base_url: "https://api.voyageai.com",
    auth_header_name: "Authorization",
    auth_header_template: "Bearer {key}",
    placeholder: "pa-...",
  },
  {
    provider: "jina",
    label: "Jina AI",
    upstream_base_url: "https://api.jina.ai",
    auth_header_name: "Authorization",
    auth_header_template: "Bearer {key}",
    placeholder: "jina_...",
  },
  {
    provider: "ai21",
    label: "AI21",
    upstream_base_url: "https://api.ai21.com",
    auth_header_name: "Authorization",
    auth_header_template: "Bearer {key}",
    placeholder: "AI21 key...",
  },
  {
    provider: "assemblyai",
    label: "AssemblyAI",
    upstream_base_url: "https://api.assemblyai.com",
    auth_header_name: "Authorization",
    auth_header_template: "{key}",
  ...
  },
  {
    provider: "gitlab",
    label: "GitLab",
    upstream_base_url: "https://gitlab.com",
  ...
  },
  {
    ...
    label: "LaunchDarkly",
    upstream_base_url: "https://app.launchdarkly.com",
    auth_header_name: "Authorization",
    auth_header_template: "{key}",
    placeholder: "LaunchDarkly token...",
  },
  {
    provider: "snyk",
    label: "Snyk",
    upstream_base_url: "https://api.snyk.io",
    auth_header_name: "Authorization",
  ...
  },
  {
    provider: "pagerduty",
    label: "PagerDuty",
    upstream_base_url: "https://api.pagerduty.com",
    auth_header_name: "Authorization",
    auth_header_template: "Token token={key}",
    placeholder: "PagerDuty key...",
  },
  {
    provider: "honeycomb",
    label: "Honeycomb",
    upstream_base_url: "https://api.honeycomb.io",
    auth_header_name: "X-Honeycomb-Team",
    auth_header_template: "{key}",
    placeholder: "Honeycomb key...",
  },
];
...
const PROVIDER_COLORS: Record<string, string> = {
  ...
  minimax: "bg-rose-500/10 text-rose-300 border-rose-500/20",
  deepl: "bg-cyan-500/10 text-cyan-300 border-cyan-500/20",
  "deepl-pro": "bg-cyan-500/10 text-cyan-200 border-cyan-500/20",
  voyage: "bg-emerald-500/10 text-emerald-300 border-emerald-500/20",
  jina: "bg-amber-500/10 text-amber-300 border-amber-500/20",
  ai21: "bg-fuchsia-500/10 text-fuchsia-300 border-fuchsia-500/20",
  assemblyai: "bg-cyan-500/10 text-cyan-300 border-cyan-500/20",
  gitlab: "bg-orange-500/10 text-orange-300 border-orange-500/20",
  launchdarkly: "bg-yellow-500/10 text-yellow-300 border-yellow-500/20",
  snyk: "bg-violet-500/10 text-violet-300 border-violet-500/20",
  pagerduty: "bg-lime-500/10 text-lime-300 border-lime-500/20",
  honeycomb: "bg-orange-500/10 text-orange-300 border-orange-500/20",
};
